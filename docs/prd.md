...
**さんま (Sanma)** は、パネルディスカッションや会議の司会者・ファシリテーターを支援するためのデスクトップアプリケーションである。  
...
さんまはこれを**オンデマンドにAIへ委譲**することで、思考の“補助脳”として働くことを狙う。
...
- **内容**:  
  ...
  取得したテキストは確定テキストとして逐次表示し、Sanma の transcript DB に保存する。  
